...
export const portfolio = {
  ...
  projects: [
    {
      title: "OpenPumTa",
      subtitle: "The 21-Day Deep Work System",
      image: "/projects/openpumta.png",
      goal: "Stop burning out on sheer willpower. Build a workspace that forces 21-day consistency and uses AI to prevent burnout.",
      challenge: "Syncing real-time timers across thousands of concurrent devices without crippling the PostgreSQL database.",
      result: "Reduced database load by 80% with Redis caching, successfully serving 1,500+ lifetime visitors with zero downtime.",
    ...
    {
      title: "Moss X",
      subtitle: "High-Performance Modular Monolith",
      image: "/projects/mossx.png",
      goal: "Build a lightning-fast E-Commerce platform that guarantees zero duplicate charges and sub-50ms catalog load times.",
      challenge: "Preventing duplicate payment charges during network failures and keeping product feeds fast during peak traffic spikes.",
      result: "Implemented strict Razorpay idempotency for 100% reliable checkouts and reduced latency to under 50ms using Redis.",
